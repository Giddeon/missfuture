...
@section("content")
    <div class="text-block create_post">
        <form action="/blog_posts" method="post" enctype="multipart/form-data">
            ...
            <label for="" style="width: 150px;">Опубликовать сейчас </label> <input type="checkbox" class="publish_now"> <input type="text" class="publish_date" placeholder="Дата публикации" name="date"><br><br>
            ...
            <label for="" style="position: relative; top: -20px;">Description <br><span class="small_text">(макс. 250 символов)</span> </label>
            <textarea rows="2" style="width: 500px;" maxlength="250" placeholder="Description" name="description" required></textarea><br><br>
            ...
            <textarea maxlength="250" rows="5" class="" style="width: 795px;" name="preview_text"></textarea><br><br>
            <label for=""><b>Текст статьи</b></label><br><br>
            <div id="summernote"></div>
			<textarea class="editor" style="display: none" name="text"></textarea>
