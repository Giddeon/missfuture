...
@section("content")
    <div class="text-block create_post">
        <form action="/{{$url}}" method="post" enctype="multipart/form-data">
            ...
            <label for="" style="width: 143px;">Опубликовать сейчас </label> <input type="checkbox" class="publish_now"> <input type="text" value="{{$post->date}}" placeholder="Дата публикации" name="date"><br><br>
            ...
            <textarea maxlength="250" rows="5" class="" style="width: 818px;" name="preview_text">{{$post->preview_text}}</textarea><br><br>
